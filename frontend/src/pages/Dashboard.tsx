  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* primary/10 bg + primary-foreground text — lime tint, black icon */}
        <StatCard
        ...
        <StatCard
          ...
          colorClass="bg-accent text-accent-foreground"
        />
        {/* accent bg + accent-foreground text — green tint bg, dark green icon */}
        <StatCard
          title="Allocations"
          ...
          colorClass="bg-accent text-accent-foreground"
        />
        {/* primary/20 bg + primary-foreground text */}
        <StatCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        <div className="bg-card text-card-foreground p-8 rounded-2xl shadow-sm border border-border">
          ...
          <div className="flex items-center justify-between p-5 bg-accent rounded-xl border border-accent-foreground/20 mt-4">
            <span className="text-accent-foreground font-medium">
              Available Beds
            </span>
            <span className="font-bold text-accent-foreground text-2xl">
